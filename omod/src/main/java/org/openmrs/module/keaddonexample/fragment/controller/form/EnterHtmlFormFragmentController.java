 ...
 */
package org.openmrs.module.keaddonexample.fragment.controller.form;
...
import org.openmrs.module.keaddonexample.util.EmrUtils;
import org.openmrs.module.keaddonexample.wrapper.EncounterWrapper;
...
public class EnterHtmlFormFragmentController {
	...
	public void controller(@FragmentParam("patient") Patient patient,
                           ...
                           @FragmentParam(value = "returnUrl", required = false) String returnUrl, FragmentConfiguration config,
                           FragmentModel model, HttpSession httpSession, PageRequest pageRequest,
                           @SpringBean ResourceFactory resourceFactory, @SpringBean KenyaUiUtils kenyaUi,
	 ...
	 */
	@SharedAction
	public SimpleObject submit(@RequestParam("personId") Patient patient, @RequestParam("formId") Form form,
                               @RequestParam(value = "encounterId", required = false) Encounter encounter,
                               @RequestParam(value = "visitId", required = false) Visit visit,
                               @RequestParam(value = "returnUrl", required = false) String returnUrl,
                               @SpringBean ResourceFactory resourceFactory, @SpringBean KenyaUiUtils kenyaUi,
                               @SpringBean FormManager formManager, FragmentActionRequest actionRequest) throws Exception {
		...
		if (fes.getContext().getMode() == Mode.ENTER
		        && fes.hasEncouterTag()
		...
		Encounter formEncounter = fes.getContext().getMode() == Mode.ENTER ? fes.getSubmissionActions()
