 ...
 */
package org.openmrs.module.keaddonexample.util;
...
public class ServerInformation {
	...
	public static Map<String, Object> getAllInformation() {
		return map("system", getSystemInformation(), "runtime", getRuntimeInformation(), "openmrs", getOpenmrsInformation(),
	...
	public static Map<String, Object> getSystemInformation() {
		...
		return map(
		    "os",
		    map("name", properties.getProperty("os.name"), "arch", properties.getProperty("os.arch"), "version",
		        properties.getProperty("os.version")), "java",
		    map("vendor", properties.getProperty("java.vendor"), "version", properties.getProperty("java.version")), "user",
		    map("language", properties.getProperty("user.language"), "timezone", properties.getProperty("user.timezone")));
	}
	...
	public static Map<String, Object> getRuntimeInformation() {
		...
		return map("freememory", runtime.freeMemory(), "totalmemory", runtime.totalMemory(), "maxmemory",
		    runtime.maxMemory(), "processors", runtime.availableProcessors());
	}
	...
	public static Map<String, Object> getOpenmrsInformation() {
		return map("version", OpenmrsConstants.OPENMRS_VERSION);
	}
	...
	public static Map<String, Object> getKenyaemrInformation() {
		...
		return map("version", build.getVersion(), "buildDate", build.getBuildDate());
	}
