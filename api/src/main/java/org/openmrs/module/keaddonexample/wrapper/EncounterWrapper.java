...
public class EncounterWrapper extends AbstractObjectWrapper<Encounter> {
	...
	/**
	 * Gets the provider of the encounter. OpenMRS supports a much more complex model of the
	 * encounter - provider relationship than we are interested in.
	 * 
	...
	/**
	 * Sets the provider of the encounter. OpenMRS supports a much more complex model of the
	 * encounter - provider relationship than we are interested in.
	 * 
